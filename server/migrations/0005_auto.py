...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field users on 'BaseDestination'
        db.delete_table(db.shorten_name(u'server_basedestination_users'))


    def backwards(self, orm):
        # Adding M2M table for field users on 'BaseDestination'
        m2m_table_name = db.shorten_name(u'server_basedestination_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('basedestination', models.ForeignKey(orm['server.basedestination'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['basedestination_id', 'user_id'])
